...
], function(jQuery, NumberFormat, BooleanType, DoubleType, DateTimeType, StringDateType, DateTimeOffsetType, DecimalType, Int16Type, Int32Type, Int64Type, SByteType, StringType, TextArrangementStringType, AbapBoolean, CurrencyType, TimeType, GuidType, MetadataAnalyser) {
	"use strict";
