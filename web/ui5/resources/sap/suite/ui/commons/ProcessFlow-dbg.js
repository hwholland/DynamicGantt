...
sap.suite.ui.commons.ProcessFlow.prototype.onAfterRendering = function () {
  ...
  if ($content && $content.length) {
    ...
    if (bScrollable) {
      ...
      } else if (sap.ui.Device.os.windows && sap.ui.Device.browser.msie && (sap.ui.Device.browser.version > 9) || sap.ui.Device.browser.edge) {
...
sap.suite.ui.commons.ProcessFlow.prototype.onfocusin = function (oEvent) {
  ...
  if (this._isHeaderMode()) {
    ...
    if (this._bSetFocusOnce && !(oTarget && oEvent.target.id.indexOf("arrowScroll"))) {
...
sap.suite.ui.commons.ProcessFlow.prototype.ontouchmove = function(event) {
...
sap.suite.ui.commons.ProcessFlow.NodeElement._calculateLaneStatePieChart = function (laneElements, lanes, internalNodes, processFlow) {
  ...
  var iPositiveCount = 0;
  var iNegativeCount = 0;
  var iNeutralCount = 0;
  var iPlannedCount = 0;
...
sap.suite.ui.commons.ProcessFlow.prototype._scroll = function (delta, duration) {
  ...
  if (!sap.ui.Device.browser.msie && !sap.ui.Device.browser.edge && this._bRtl) {
    delta = -delta;
