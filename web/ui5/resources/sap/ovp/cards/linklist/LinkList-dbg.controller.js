(function() {
	...
	sap.ui.controller("sap.ovp.cards.linklist.LinkList", {
        ...
        getSpansWhenNoDefaultSpanMentioned: function () {
            var oCardPropertiesModel = this.getCardPropertiesModel();
            var iLinkListItemHeight = oCardPropertiesModel.getProperty('/staticContent') ? this.getItemHeight(this, OVPLINKLIST, true) : oCardPropertiesModel.getProperty('/cardLayout/itemHeight');
            var iHeaderHeight = 0;
