sap.ui.define([], function() {
	...
	var AnnotationHelper = {
		...
		*/
		...
		checkIfChartNavigationIsEnabled: function(oItabItem, aSubPages, sEntitySetFromManifest, oQuickVariantSelectionX) {
			var bTemp = oItabItem.showItemNavigationOnChart;
			if (!bTemp) {
				return false;
			}

			// for table tabs with different entitySets internal navigation should be disabled
			if (!!AnnotationHelper.checkIfDiffEntitySetsMode(oQuickVariantSelectionX)) {
				return false;
			}
