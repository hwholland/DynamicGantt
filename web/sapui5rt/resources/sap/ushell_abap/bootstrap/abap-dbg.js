...
// end   sap/net/AuxWindowFrameProvider.js *******************************************
     ...
     */
    sap.ui2.srvc.testPublishAt(sap.ushell_abap.bootstrap); /** @memberOf outerClosure */
    function createXhrLogonEventHandler(oWindow) {
        return new XhrLogonEventHandler(oWindow);
    }
     ...
     * @private
     */
    function XhrLogonEventHandler(oWindow) {
    ...
    XhrLogonEventHandler.prototype._handleAuthenticationRequiredNoUi5 = function () {
     ...
     */
    XhrLogonEventHandler.prototype._showErrorAndReload = function (oTitleText, oMessageText, fnFallbackIfUi5NotLoaded) {
        ...
        if (sap && sap.ui && (typeof sap.ui.getCore === "function")
            ...
            fnFallbackIfUi5NotLoaded.call(this);
       }
    };
    ...
    function initXhrLogon(oConfig, oLocalFrameLogonManager, sPreviousXhrLogonMode, bFinalIfNonDefaultMode) {
        var sLocalXhrLogonMode = getUrlParameterValue("sap-ushell-xhrLogon-mode") || oConfig && oConfig.xhrLogon && oConfig.xhrLogon.mode || "frame",
            oXhrLogonEventHandler = createXhrLogonEventHandler(),
            oFrameProvider;
