...
sap.ui.define([
	...
	TimePopoverHandler.prototype._handleTimePopoverDragStart = function(oEvent){
		...
		if (Core.getConfiguration().getRTL()){
			iToXGap = this._oSourceChart._oDraggingData.dragStartPoint.x - this._oSourceChart._oDraggingData.dragStartPoint.shapeX;
			this._iOffsetX = Math.ceil(iToXGap);
		}else{
			iToXGap = this._oSourceChart._oDraggingData.dragStartPoint.shapeX + this._oSourceChart._oDraggingData.dragStartPoint.shapeWidth - this._oSourceChart._oDraggingData.dragStartPoint.x;
			this._iOffsetX = -Math.ceil(iToXGap);
		}
