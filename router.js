...
router.prototype.loadRoutes = function() {
    ...
    this.app.get("/web", function(oRequest, oResponse) {
        oResponse.redirect("/web/navigation/index.html");
    });
    ...
    this.app.get("/BasicGanttChart", function(oRequest, oResponse) {
        oResponse.redirect("/web/ui5/test-resources/sap/gantt/demokit/BasicGanttChart/index.html");
    });    
};
